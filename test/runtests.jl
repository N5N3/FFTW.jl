...
@testset "rfft/rfftn" begin
    ...
    @testset "with preallocated array" begin
...
@testset "Self-test: $(T)" for T in (Complex{Float32}, Complex{Float64})
...
@testset "Inversion, scaling, and pre-allocated variants: $(T)" for T in (Complex{Float32}, Complex{Float64})
...
@testset "Base Julia issue #17896" begin
    a = rand(5)
